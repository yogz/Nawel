...
/**
 * Substitut compact d'`OutingProfileCard` pour la liste mensuelle de la
 * home : on troque les CTAs RSVP/vote inline contre un simple badge état
 * + navigation au tap. L'invité retrouve l'inline RSVP en ouvrant la
 * sortie. `data-flash` est togglé 1 s par le parent quand le user tap
 * une cellule du heatmap pointant cet outing.
 */
    ...
    >
      {outing.heroImageUrl ? (
        ...
        <img
          ...
          height={48}
          loading="lazy"
          className="size-12 shrink-0 rounded-lg bg-surface-200 object-cover object-top"

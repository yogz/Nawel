...
export function SessionStatusCta() {
  ...
  return (
    ...
    >
      ...
      <span
        aria-hidden="true"
        className="pointer-events-none absolute -inset-x-3 inset-y-0 -skew-x-12 bg-gradient-to-r from-transparent via-acid-600/80 to-transparent motion-safe:animate-acid-sheen motion-reduce:hidden"
      />
      S&apos;identifier
      <ArrowRight
        aria-hidden="true"

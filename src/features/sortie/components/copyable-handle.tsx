...
export function CopyableHandle({ username, origin }: Props) {
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-1.5 rounded-full bg-acid-50 px-3 py-1.5 text-sm font-semibold text-acid-700 transition-colors hover:bg-acid-100 motion-safe:active:scale-95"
    >
      {copied ? (
        <>

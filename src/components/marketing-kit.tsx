  ...
  const strategyB = {
    ...
    posts: [
      ...
      },
      {
        ...
        caption: `🍷 Bon appétit.\n\nPosez le téléphone. Profitez de vos amis. \n\nCoList a géré le chaos pour que vous puissiez savourer le moment.\n\nCréez votre prochain événement maintenant (lien en bio).\n\n#DinnerTime #Cheers #GoodVibes #CoListApp`,
      },
    ],
  };

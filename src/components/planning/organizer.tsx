            ...
            onDragEnd={(e: DragEndEvent) => {
              ...
              if (typeof over.id === "string" && over.id.startsWith("service-")) {
                ...
                if (targetItem && targetItem.service.id !== found.service.id) {
                  const targetIndex = targetItem.service.items.findIndex(
                    (i: any) => i.id === over.id
                  );
      ...
      >
        {sheet?.type === "item" && (
          <ItemForm
            ...
            allServices={plan.meals.flatMap((m: any) =>
              m.services.map((s: any) => ({ ...s, mealTitle: m.title || m.date }))
            )}
            ...
            onToggleIngredient={
              sheet.item
                ? (id, checked) => handleToggleIngredient(id, sheet.item!.id, checked)
                : undefined
            }
            onDeleteIngredient={
              sheet.item ? (id) => handleDeleteIngredient(id, sheet.item!.id) : undefined
            }
            onCreateIngredient={
              sheet.item
                ? (name, qty) => handleCreateIngredient(sheet.item!.id, name, qty)
                : undefined
            }
        ...
        {sheet?.type === "meal-edit" && (
          <MealForm
            meal={sheet.meal}
            onSubmit={(date: string, title?: string) =>
              handleUpdateMeal(sheet.meal.id, date, title)
            }
        ...
        {sheet?.type === "person" && (
          <PersonForm readOnly={readOnly} onSubmit={handleCreatePerson} />
        )}

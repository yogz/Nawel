...
export const createPersonAction = withErrorThrower(
  async (input: z.infer<typeof createPersonSchema>) => {
...
export const updatePersonAction = withErrorThrower(
  async (input: z.infer<typeof updatePersonSchema>) => {
...
export const deletePersonAction = withErrorThrower(
  async (input: z.infer<typeof deletePersonSchema>) => {
    await verifyEventAccess(input.slug, input.key);

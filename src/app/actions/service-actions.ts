...
export const createServiceAction = withErrorThrower(
  async (input: z.infer<typeof createServiceSchema>) => {
...
export const updateServiceAction = withErrorThrower(
...
export const deleteServiceAction = withErrorThrower(
  async (input: z.infer<typeof deleteServiceSchema>) => {
    await verifyEventAccess(input.slug, input.key);

  ...
  return (
    <main className="mx-auto max-w-xl px-6 pb-24 pt-10">
      ...
      {outing.status !== "cancelled" && !isPastEvent && (
        <section className="mt-12 border-t border-surface-400 pt-8">
          <p className="mb-3 inline-flex items-center gap-2 font-mono text-[10.5px] uppercase tracking-[0.22em] text-hot-500">
            <span
              aria-hidden
              className="h-1.5 w-1.5 animate-pulse rounded-full bg-hot-500 shadow-[0_0_10px_var(--sortie-hot)]"
            />
            ─ zone sensible ─
          </p>
          <h2 className="mb-2 text-2xl font-black tracking-[-0.025em] text-ink-700">
            Annuler la sortie
          </h2>
          <p className="mb-4 font-mono text-[11px] uppercase tracking-[0.18em] text-ink-400">
